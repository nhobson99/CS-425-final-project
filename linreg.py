...
rank_commit_size, rank_commit_size_p = linreg(expected_c, features_c)
...
rank_message_length, rank_message_length_p = linreg(expected_l, features_l)
...
rank_message_readability, rank_message_readability_p = linreg(expected_r, features_r)
